...
function renderStudent(data) {
    ...
    for (var index = 0; index < json.length; index++) {
        ...
        var cardHtml = '  <div class="card bg-primary container-fluid"  style="width:400px" id="' + json[index].id + '">'
            + '<div class ="card-header"><h3>' + json[index].firstName + ' ' + json[index].lastName + '</h3>' + '</div>'
            ...
            + '<div class="btn-group" id="update' + json[index].id + '">'
